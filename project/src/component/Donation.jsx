...
const DonationForm = () => {
  ...
  return (
    <div
      className='flex justify-center items-center h-screen w-[70%] m-auto mt-10 shadow-2xl border-l-8 border-b-8 border-red-400'
      style={{ backgroundImage: `url(${backImage})`, backgroundSize: 'cover', backgroundPosition: '' }}
    >
      <div className='bg-white w-4/5 md:w-2/3 lg:w-1/2 p-6 rounded-md shadow-xl mt-10 relative bottom-12'>
