...
const HelpJobBank = () => {
  ...
  return (
    <div
      className="flex justify-center items-center h-screen w-[70%] md:w-[90%] m-auto mt-5 shadow-lg border-l-4 border-b-4 border-red-400 md:mb-10 mb-6 m"
        ...
        {step === 1 && (
          <div className="space-y-3">
            ...
            <div className="flex justify-center">
              <button
                className="bg-red-600 text-white font-semibold py-2 px-4 w-full hover:bg-white hover:text-red-600 border border-red-600 rounded transition duration-300"
                onClick={handleNext}
              >
                Submit
              </button>
