...
const FoodAid = () => {
   ...
   <>
    <PassPro backImgsrc = "../src/images/Web-Icon.png "
      ...
      p = "
Food Aid
At Help Human rights, we believe that access to nutritious food is a fundamental human right. Our Food Aid program is dedicated to combating hunger and food insecurity within our community. We provide essential meals and groceries to individuals and families in need, ensuring that no one goes hungry. From distributing food packages to organizing community kitchens, our efforts are focused on delivering sustenance and hope to those struggling to make ends meet.

Through partnerships with local farmers, food banks, and volunteers, we are able to offer a variety of fresh and nutritious foods. Our goal is not only to alleviate immediate hunger but also to promote healthy eating habits and improve overall well-being. We prioritize reaching the most vulnerable populations, including children, the elderly, and those facing financial hardships.
" 
/>
