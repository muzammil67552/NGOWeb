...
const HelpEducation = () => {
  return (
    ...
    <div className="relative h-48 bg-contain bg-no-repeat bg-center "  style={{ backgroundImage: "url('../src/images/Website-Fave-Icon.png')" }}>
      ...
      <div className="container mx-auto p-8 flex flex-col md:flex-row items-center text-justify">
       ...
       <div className="w-full md:w-1/2 p-4"
        ...
        <img src="../src/images/education.jpg"
